    ...
    render ()
    {
        return (
            ...
            <Segment.Group>
                ...
                <Segment textAlign='center' inverted color='black'><strong>CONTACT US</strong><br/><br/><p>101, 10010-100 St NW<br/>Edmonton, AB T5Y5V5</p><p>+1 (780) 555 5555<br/>info@parystore.ca</p>
                </Segment>
                ...
                <Segment textAlign='center' inverted color='black'><strong>BUSINESS HOURS</strong><br/><br/><Icon name='clock' size='large' /><br/><br/><p>Mon-Fri: 07:00-20:00<br/>Sat-Sun: 08:00-22:00</p>
                </Segment>
                ...
                <Segment inverted color='black' textAlign='center'><p>www.parystore.ca</p><br/>Copyright &#169; PARYStore 2020</Segment>
            </Segment.Group>
        );
    }
}